...
// ── IMPORTANT: paths here must exactly match the routes in App.jsx ──
// App.jsx uses a root "/" layout with relative child routes, so all
// paths below are absolute but WITHOUT any /app/ prefix.
const ALL_NAV = [
  ...
  { to: '/directory-staff',  label: 'Staff Directory',  icon: BookUser,        module: 'staff' },  // was /app/staffdirectory — wrong
