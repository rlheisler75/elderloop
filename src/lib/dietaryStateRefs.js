...
export const DIETARY_STATE_REFS = {
  ...
  FL: {
    label: 'Florida',
    foodCode: {
      summary: 'Confirmed by direct read of the complete current rule text: 59A-4.110 does not reference the FDA Food Code, DOH Chapter 64E-11, DBPR Chapter 61C, or any other food safety/sanitation code.',
      statute: 'NOT FOUND (confirmed absence)',
      confidence: 'high',
      note: 'Verified against the full current rule document (eff. 3/22/2023) directly, not just a search snippet — Florida genuinely has no dietary-specific sanitation-code cross-reference in this rule.',
      source: 'https://www.flrules.org/gateway/readFile.asp?sid=0&type=1&tid=26895498&file=59A-4.110.doc',
    },
    menuRequirements: {
      summary: 'Confirmed by direct read of the complete current rule text: 59A-4.110 contains no menu dating/posting/retention-period language and no therapeutic-diet-order-signature requirement.',
      statute: 'NOT FOUND (confirmed absence)',
      confidence: 'high',
      note: 'Verified against the full current rule document directly. Florida\'s dietary rule is unusually thin compared to TX/TN/IN/OH — it relies on the federal 42 CFR 483.60 baseline for menu content.',
      source: 'https://www.flrules.org/gateway/readFile.asp?sid=0&type=1&tid=26895498&file=59A-4.110.doc',
    },
    dietitianOversight: {
      summary: 'Facility must designate a full-time Director of Food & Nutrition Services (a Florida-licensed RD/RDN under Ch. 468 Part X, or someone meeting the federal 42 CFR 483.60(a)(1)/(2) standard). If the Director isn\'t a dietitian, the facility "shall obtain consultation from a qualified dietitian" — confirmed no specific hours/month figure exists, unlike Texas/Indiana\'s numeric formulas or Ohio\'s monthly cadence.',
